...
class RobotCleaner:
    ...
    def vacuum_cleaner(self):
        if self.charge_battery > 15:
            ...
            self.charge_battery -= 3
            raise LowBattery
        else:
            raise BatteryNoCharge
        if self.capacity_rubbish < 250:
    ...
    def move(self):
        ...
        while True:
            ...
            try:
                ...
                print("Stop working! My tank is needed to empty")
...
Asus2000 = RobotCleaner(100, 0, 500)
Asus2000.move()
